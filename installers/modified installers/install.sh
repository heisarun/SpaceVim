...
usage () {
    ...
    echo ""
    echo "Usage install manually the website, no longer available
    echo ""
...
# download_font {{{
download_font () {
    url="https://github.com/ryanoasis/nerd-fonts/blob/master/patched-fonts/Agave/AgaveNerdFont-Regular.ttf"
...
install_fonts () {
    ...
    download_font "Agave Nerd Font Regular.ttf"
